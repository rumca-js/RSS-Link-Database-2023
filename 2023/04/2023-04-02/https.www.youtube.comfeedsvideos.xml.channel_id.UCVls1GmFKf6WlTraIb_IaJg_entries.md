...
## Adding Custom Actions To Your File Manager
 - [https://www.youtube.com/watch?v=i28UNDO8Q7E](https://www.youtube.com/watch?v=i28UNDO8Q7E)
 - RSS feed: https://www.youtube.com/feeds/videos.xml?channel_id=UCVls1GmFKf6WlTraIb_IaJg
 - date published: 2023-04-02 13:00:21+00:00

One of the coolest customizations that you can make to your file manager is to add your own custom actions to the context menus.  For example, in this video, I create a custom action where if I right click on a directory, the context menu now offers me a choice to open that directory inside Emacs Dired.  Or I can create a "Open As Root" custom action.  The sky is the limit!
