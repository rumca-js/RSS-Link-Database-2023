...
## Navigating Emacs Documents With Imenu
 - [https://www.youtube.com/watch?v=YM0TD8Eg9qg](https://www.youtube.com/watch?v=YM0TD8Eg9qg)
...
'imenu' is a nifty program inside of Emacs that displays a menu of "major definitions" that allows you to quickly navigate the document that your working in.  'imenu-list' is an even better implementation of 'imenu'.
