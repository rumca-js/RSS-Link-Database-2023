...
## First Look At Rhino Linux With The Unicorn Desktop
 - [https://www.youtube.com/watch?v=SAiCA6CeiIQ](https://www.youtube.com/watch?v=SAiCA6CeiIQ)
 - RSS feed: https://www.youtube.com/feeds/videos.xml?channel_id=UCVls1GmFKf6WlTraIb_IaJg
 - date published: 2023-08-10T13:00:20+00:00

I'm taking a quick first look at Rhino Linux, which just released it's first ISO.  Rhino Linux is a rolling release Ubuntu-based distro that features a beautiful Xfce-based desktop.  It also contains its own package manager wrapper that can install packages from apt, flatpak, snap or pacstall (an AUR-styled community repo for Ubuntu/Debian).
