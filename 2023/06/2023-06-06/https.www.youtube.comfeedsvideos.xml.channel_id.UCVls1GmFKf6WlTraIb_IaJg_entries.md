...
## QMMP Is A Modern Cross Platform Winamp Alternative
 - [https://www.youtube.com/watch?v=kvMSICET4GQ](https://www.youtube.com/watch?v=kvMSICET4GQ)
 - RSS feed: https://www.youtube.com/feeds/videos.xml?channel_id=UCVls1GmFKf6WlTraIb_IaJg
 - date published: 2023-06-06 13:00:38+00:00

qmmp is a free and open-source cross-platform audio player that is similar to Winamp. It is written in C++ using the Qt widget toolkit for the user interface. It officially supports the operating systems Linux, FreeBSD and Microsoft Windows. 
